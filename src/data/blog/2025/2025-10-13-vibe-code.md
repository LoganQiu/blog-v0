---
title: "[转]Vibe code is legacy code"
desc: "此文转载，表达了对目前滥用 AI 进行不负责任地代码生成的担忧，“Code that nobody understands is tech debt”。"
slug: vide-code
pubdate: 2025-10-13
categories:
  - Thoughts 思考
...
转载：<https://blog.val.town/vibe-code>
作者：[GitHub@stevekrouse](https://stevekrouse.com/)
...
最糟糕的情况是，一个非程序员编写了一个他们打算维护的大型项目。这就相当于在没有先解释债务概念的情况下就把信用卡交给孩子。

如果您不理解代码，您唯一的办法就是让人工智能为您修复它，这就像用另一张信用卡偿还信用卡债务一样。
